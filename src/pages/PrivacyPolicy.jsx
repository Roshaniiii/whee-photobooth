    ...
    <div className="page-wrapper privacy-policy-wrapper" style={{
      ...
      <div className="page-content privacy-page-content" style={{
        ...
        <div style={{
          ...
          <p style={{ color: '#917264', fontSize: '14px', marginBottom: '24px' }}>
          ...
          <p style={{ marginBottom: '24px' }}>
            We use Your Personal Data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank" rel="noopener noreferrer" style={{ color: '#DF82A3', textDecoration: 'none' }}>Privacy Policy Generator</a>.
          </p>
          ...
          <ul style={{ paddingLeft: '24px', marginBottom: '32px' }}>
            <li>
              By visiting this page on our website: <Link to="/contact" style={{ color: '#DF82A3', textDecoration: 'none' }}>https://wheephotobooth.site/contact</Link>
            </li>
          </ul>
